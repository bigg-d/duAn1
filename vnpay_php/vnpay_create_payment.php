...
$vnp_TmnCode = "MQXHV91X"; //Mã định danh merchant kết nối (Terminal Id)
$vnp_HashSecret = "SQTPCUNMIMZTUDKOFQLOPHJOJSQBDYAC"; //Secret key
$vnp_Url = "https://sandbox.vnpayment.vn/paymentv2/vpcpay.html";
$vnp_Returnurl = "http://localhost/duAn1/index.php?act=checkout_success&orderId=".$orderId;
...
$grandTotal = $grandTotal * 26000;
$vnp_TxnRef = rand(1,10000); //Mã giao dịch thanh toán tham chiếu của merchant
$vnp_Amount = $grandTotal; // Số tiền thanh toán
